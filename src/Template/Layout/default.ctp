    ...
    <nav class="navbar navbar-inverse">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/cakephp/portal">Tienda Online</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    <li class="active"><a href="/cakephp/portal">Home <span class="sr-only">(current)</span></a></li>
                    ...
                    <li><a href="/cakephp/categorias">Categorias</a></li>
                        ...
                        <li><a href="http://localhost/cakephp/clientes/">Clientes</a></li>
                    <li class="dropdown">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li role="separator" class="divider"></li>
                            <li><a href="/cakephp/Usuarios/logout">Cerrar Sesión</a></li>
                        </ul>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
